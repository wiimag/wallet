...
bool logo_render(const char* symbol, size_t symbol_length, const ImVec2& size = ImVec2(0, 0), bool background = false, bool show_tooltip = true, ImRect* fill_rect = nullptr);
