...
template <size_t N> FOUNDATION_FORCEINLINE config_handle_t config_set(config_handle_t v, const char(&key)[N], const char* string_value, size_t string_length) { 	return config_set(v, key, N -1, string_value, string_length); }
