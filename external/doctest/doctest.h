...
int  Context::failureCount() { return 0; }
...
#define DOCTEST_PARSE_STR_OPTION(name, sname, var, default)                                        \
    ...
    DOCTEST_PARSE_AS_BOOL_OR_FLAG("list-test-cases", "ltc", list_test_cases, false);
    DOCTEST_PARSE_AS_BOOL_OR_FLAG("list-test-suites", "lts", list_test_suites, false);
...
int Context::failureCount() {
    using namespace detail;
    return p->numAssertsFailed;
}
